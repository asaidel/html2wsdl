...
public class TransaccionRiesgoEvaluarWsdlWriterTest extends FreemarkerWriterTest 
{	
	@Before
	...
	public void expTest() throws Exception
	{
		...
		OffsetParameters offsetParameters = new OffsetParameters(12, 7, 33, 49, 3, 3);
		
		File inputHtml = new File(
				"resources/spec/ATC02 - OSB - transaccionRiesgoEvaluar_files/sheet003.htm");
	...
	{
		InputParameters parametersIn = new InputParameters("FingerPrint", "FraudAnalysis", "Update", "v1.0", "CORP",
		...
		OffsetParameters offsetParameters = new OffsetParameters(12, 7, 34, 49, 3, 3);
