...
public class TransaccionRiesgoIniciarWsdlWriterTest extends FreemarkerWriterTest 
{	
	@Before
	...
	{
		InputParameters parametersIn = new InputParameters("Transaccion", "Riesgo", "Iniciar", "v1.0", "FIF",
				"CORP", "OSB", "v2016.12", null);		
		...
		OffsetParameters offsetParameters = new OffsetParameters(12, 7, 35, 51, 4, 3);
		
		File inputHtml = new File(
				"resources/spec/ATC02 - OSB - transaccionRiesgoIniciar_files/sheet003.htm");
	...
	{
		InputParameters parametersIn = new InputParameters("Transaction", "RiskCenter", "SendXMLTrx", "v1.0", "CORP",
				"CORP", "OSB", "v2016.12", "Paytrue");
	...
	//@Test
	public void implTest2() throws Exception
	{
		InputParameters parametersIn = new InputParameters("FingerPrint", "FraudAnalysis", "Check", "v1.0", "CORP",
				"CORP", "OSB", "v2016.12", "Vucore");
