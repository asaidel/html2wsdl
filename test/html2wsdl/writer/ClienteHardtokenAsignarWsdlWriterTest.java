...
public class ClienteHardtokenAsignarWsdlWriterTest extends FreemarkerWriterTest 
{	
	@Before
	...
	{
		InputParameters parametersIn = new InputParameters("Cliente", "Hardtoken", "Desasignar", "v1.0", "FIF",
	...
	{
		InputParameters parametersIn = new InputParameters("Totp", "Hardtoken", "Unassign", "v1.0", "CORP",
				"CORP", "OSB", "v2016.09", "Vucore");
